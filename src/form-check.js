...
export default function FormCheck() {
    ...
    const size = ['small','medium','lage','larger']
    let checkedStyles = []
    let checkedSize = ''
            ...
            <div className="mt-4 mx-auto p-3 rounded"
                style={{width:'450px',background:'#cee'}}>
                        ...
                        size.map((sz,i)=>
                        {
                            return(
                                <div className="form-check form-check-inline  m-2">
                                    ...
                                    className="form-check-input" onChange={onClickRadio}/>
                    ...
                    <div className="text-center mt-4">
                        <button type="button" className="btn btm-sm px-4 btn-primary" onClick={onClickButton}>
                            OK
                        </button>
                    </div>
